import { Config, ConfigParameters, getConfig, AuthorizationParameters, DeepPartial } from '../../src/zsession';
...
describe('Config', () => {
  ...
  it('should set idpLogout to true when zIdentityLogout is true', () => {
    const config = getConfig({
      ...defaultConfig,
  ...
  it('zIdentityLogout and idpLogout should default to false', () => {
    const config = getConfig(defaultConfig);
    expect(config).toMatchObject({
  ...
  it('should not set zIdentityLogout to true when idpLogout is true', () => {
    const config = getConfig({
      ...defaultConfig,
      idpLogout: true
    });
