...
const paramsSchema = Joi.object({
  ...
  session: Joi.object({
    ...
    .default()
    .unknown(false),
  zAuthLogout: Joi.boolean().optional().default(false),
      ...
      then: Joi.string()
        ...
        .rule({
          ...
          message:
            ...
            'see https://github.com/zauth/express-openid-connect/blob/master/FAQ.md'
        })
    }),
  ...
  idpLogout: Joi.boolean()
    .optional()
    .default((parent) => parent.zAuthLogout || false),
